...
const HERESY_WEAPONS = {
  ...
  'Power sword':          { cat:'Power', rng:'-', S:'User',AP:'3', type:'Melee, Rending (6+)' },
  'Power axe':            { cat:'Power', rng:'-', S:'+1',  AP:'2', type:'Melee, Unwieldy' },
  'Power maul':           { cat:'Power', rng:'-', S:'+2',  AP:'3', type:'Melee' },
  'Power lance':          { cat:'Power', rng:'-', S:'+1',  AP:'3', type:'Melee, Reach (1)' },
  'Master-crafted power maul': { cat:'Power', rng:'-', S:'+2', AP:'3', type:'Melee, Master-crafted', note:'Speaker of the Dead.' },
